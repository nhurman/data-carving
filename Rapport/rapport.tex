...
\section{Introduction}
  \subsection{Contexte} \input{parts/01-contexte.tex}
  \subsection{Etude de l'existant} \input{parts/01-etude-existant.tex}
\section{Cahier des charges}
  \input{parts/02-cahier_des_charges.tex}
\section{Présentation du logiciel}
  \subsection{Technologies utilisées} \input{parts/03-technologies.tex}
  \subsection{Interface} \input{parts/03-interface.tex}
  \subsection{Fonctionnalités} \input{parts/03-fonctionnalites.tex}
\section{Algorithmique}
  \subsection{Analyse} \input{parts/04-analyse.tex}
  \subsection{Aide à la décision} \input{parts/04-aide_decision.tex}
  \subsection{Pseudo-code}
  \subsection{Complexité}
  \subsection{Performances}
\section{Gestion du projet}
  \input{parts/05-gestion_projet.tex}
\section{Conclusion}
  \subsection{Points remarquables au cours du projet}  \input{parts/06-remarques.tex}
  \subsection{Améliorations envisageables} \input{parts/06-ameliorations.tex}
\bibliography{biblio}
