...
\section{Algorithmique}
  \subsection{Analyse des dumps} \label{04-analyse} \input{parts/04-analyse.tex}
  \subsection{Complexité} \input{parts/04-complexite.tex}
...
\section{Améliorations envisageables}
  \input{parts/06-ameliorations.tex}
\newpage
\bibliography{biblio}
