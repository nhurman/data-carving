...
\section{Présentation de l'interface}
  \input{description_interface.tex}
\section{Dumps \& Sets}
  \input{sets.tex}
\section{Vues}
  \input{vues.tex}
...
\section{Menu d'aide à la décision : Algorithms}
  ...
  \subsection{Fonction Similarities} \label{Similarities} \input{algorithms-similarities.tex}
  \subsection{Fonction Dot Plot Pattern} \label{Dot_Plot_Pattern} \input{algorithms-dotplot.tex}
\newpage
